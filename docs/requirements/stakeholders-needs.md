...
| ID                | AddMember  |
|-------------------|---|
| Назва             | Додати користувача у проєкт  |
| Учасники          |  Керівник проєкту, Система |
...
| Виключні ситуації |  <font color="Maroon">AccessDeniedException</font> - відмовлено у доступі, користувач не має необхідних прав. </br> <font color="Maroon">NullReferenceException</font> - не заповнені обов'язкові поля. </br> <font color="Maroon">NoUserFoundException</font> - неможливо знайти користувача за вказаним ім'ям. </br> |
...
| Виключні ситуації |  <font color="Maroon">AccessDeniedException</font> - користувач не має відповідних прав </br> <font color="Maroon">NullReferenceException</font> - користувач не заповних необхідні поля </br> <font color="Maroon">NoUserFoundException</font> - користувач ввів імʼя нового керівника проєкту неправильно </br> |
...
| Виключні ситуації |  <font color="Maroon">AccessDeniedException</font> - відмовлено у доступі, оскільки користувач не має необхідних прав </br> <font color="Maroon">NullReferenceException</font> - не заповнені обов'язкові поля. </br> <font color="Maroon">NoUserFoundException</font> - користувача з вказаним ім'ям не знайдено </br>  |
...
_*Адміністратор*_ - це користувач системи, який має особливі права доступу та відповідальності за управління та підтримку системи. Адміністратор відповідає за налаштування та конфігурацію системи, забезпечення безпеки та цілісності даних, управління доступом користувачів та вирішення технічних проблем.
...
Інтерфейс керівника проєкту розширяє інтерфейс розробника і наділяється правами керування складом команди.
