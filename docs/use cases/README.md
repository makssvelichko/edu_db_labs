...
| Виключні ситуації | <font color="Black">NullReferenceException - користувач не заповнив необхідні поля. </br> AccessDeniedException - користувач не має відповідних прав. </br> NameAlreadyExistsException - проект з такою назвою вже існує.</font> |
...
|Система|
    if (Користувач має відповідні права?) then (Так)
        ...
        if (Користувач заповнив усі поля?) then (Так)
            :Система створює проект та показує його на головній сторінці тімліда та прив'язаних до нього користувачів;
        else (Ні)
            :Користувач не заповнив необхідні поля
              <font color="Black">NullReferenceException</font>;
        endif
    else (Ні)
        :Користувач не має відповідних прав
          <font color="Black">AccessDeniedException</font>;
    endif
    stop;
@enduml
...
if (Користувач авторизований і має відповідні права?) then (Так)
    ...
    if (Користувач заповнив усі поля?) then (Так)
        :Система змінює проект з вказаними даними;
    else (Ні)
        :Користувач не заповнив необхідні поля;
        stop;
    endif
...
| Виключні ситуації |  <font color="Black">AccessDeniedException - користувач не має відповідних прав. </br> NullReferenceException - користувач не заповнив необхідні поля. </br> InvalidTaskNameException - користувач ввів неправильне ім'я проекту|
