...
@startuml
    ...
    |Користувач|
    start;
        : Користувач знаходиться в розділі "Проєкти" і натискає кнопку "Створити проєкт";
     |Система|
        : Перевіряє чи має користувач необхідні права
         <font color="red">AccessDeniedException</font>;
        : Відкриває форму з інформацією про проєкт;    
    |Користувач|
        : Вводить необхідні дані (назва, дату початку-кінця проєкта, додає учасників 
    ...
    |Система|
        : Перевіряє корректність введених даних
         <font color="red">NullReferenceException</font>;
    |Система|
        : Оновлює дані, зберігає проєкт та повідомляє менеджеру про
...
@startuml
    ...
    |Користувач|
    start;
        : Переходить у розділ "Проєкти" та обирає потрібний для редагування проєкт;
     ...
     |Система|
        ...
        : Відкриває форму з інформацією про проєкт;    
    |Користувач|
        : Редагує необхідні дані (назва, дату початку-кінця проєкта, учасників 
         команди зі списку співробітників, додає документацію/файли)
         <font color="red">NameAlreadyExistsException</font>;
    |Користувач|
...
@startuml
    ...
    |Користувач|
    start;
        : Переходить у розділ "Проєкти" та обирає потрібний для видалення проєкт;
